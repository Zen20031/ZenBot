  ...
  msg.embeds.forEach(async embed => {
    ...
    { 
      ...
      if(tiier===1)
      {
        ...
        .setAuthor(`${msg.author.username}`,msg.author.avatarURL())
        .setTimestamp()
        .setDescription(`<@${idbest}> has claimed ${nammess}`)
        .setFooter(`Server name: ${msg.guild.name}`)
          .setColor('#f2f2f2')
        tiier=0;
        ret.edit(r);   
...
//logs!!!
   ...
   if(msg.embeds[0].title.includes('Tier: 2'))
    ...
    if(msg.embeds[0].title.includes('Tier: 5'))
     {
        return msg.channel.send("<@&718449953621409793>  **E B I C** tier 5 spawned, go get it")} 
    if(msg.embeds[0].title.includes('Tier: 6'))
    { 
      console.log(`${msg.embeds[0].title} in server 9`)
      return msg.channel.send("<@&718449953621409793> **E B I C** tier 6 spawned, go get it")} 
    //console.log("WE HAVE A PROBLEM!!!");// if there are no embeds, this code won't run.
      });
  }
    ...
    if(msg.embeds[0].title.includes('Tier: 5'))
     {
      ...
      .setFooter(`Server name: ${msg.guild.name}`)
        ...
        retts= await client.channels.cache.get(x).send(r);
        console.log(`${msg.embeds[0].title} in server 9`);
        return msg.channel.send("<@&703244026551206008>  **E B I C** tier 5 spawned, go get it ")} 
    if(msg.embeds[0].title.includes('Tier: 6'))
    {let xp=14;
      let myinterval;
      let ok=1;
      ...
      .setFooter(`Server name: ${msg.guild.name}`)
        ...
        retts= await client.channels.cache.get(x).send(r);
      console.log(`${msg.embeds[0].title} in server 9`)
      return msg.channel.send("<@&703244026551206008> **E B I C** tier 6 spawned, go get it ")} 
    //console.log("WE HAVE A PROBLEM!!!");// if there are no embeds, this code won't run.
      });
  }
...
//logs!!!
   ...
   if(msg.embeds[0].title.includes('Tier: 2'))
    { 
     ...
     if(msg.embeds[0].title.includes('Tier: 3'))
     { 
       msg.channel.send("<@&716233012282654831>  **E B I C** tier 3 spawned, go get it!") 
     ...
     {tiertts=4;namess=msg.embeds[0].title;
      msg.channel.send("<@&716233012282654831>  **E B I C** tier 4 spawned, go get it!")
       console.log(`${msg.embeds[0].title} in server 1`)
       const r= new MessageEmbed()
       .setAuthor(`${msg.author.username}`,msg.author.avatarURL())
      .setTimestamp()
    ...
    if(msg.embeds[0].title.includes('Tier: 5'))
     {
       msg.channel.send("<@&716233012282654831>  **E B I C** tier 5 spawned, go get it!")
    ...
    if(msg.embeds[0].title.includes('Tier: 6'))
    {
       msg.channel.send("<@&716233012282654831>  **E B I C** tier 6 spawned, go get it!")
   ...
   if(msg.embeds[0].title.includes('Tier: 2'))
    ...
    if(msg.embeds[0].title.includes('Tier: 5'))
     {let xp=14;
      ...
      msg.channel.send("<@&717043443142099057> Hey, look at that! A tier 5 spawned! Go get it!")
        } 
    if(msg.embeds[0].title.includes('Tier: 6'))
    { 
      let xp=14;
...
//logs!!!
  ...
  client.login("NzEwNDQwMDIwNjc0MzQ3MTA5.XsEJZw.UtUY5p86mxv7UquKG2TCPyovACI");    
